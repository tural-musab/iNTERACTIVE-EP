...
-- Rol bilgisi doğrudan `raw_user_meta_data` içinde verildiği için, 
-- trigger'ımız profili tek seferde ve doğru rolle oluşturacaktır.
...
VALUES (
    ...
    NOW(), 
    '{"full_name": "Ayşe Öğretmen", "role": "teacher"}'::jsonb
)
